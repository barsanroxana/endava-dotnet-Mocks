using FoodPal.Orders.Mock.GreekCuisine.Api.BackgroundProcessing;
using FoodPal.Orders.Mock.GreekCuisine.Api.Filters;
...
namespace FoodPal.Orders.Mock.GreekCuisine.Api
{
    public class Startup
    {
		...
		private const string ApiTitle = "Mock Greek Cruisine API";
		private const string ApiDescription = "Mock Greek Cruisine API";
